...
▂▃▄▅▆▇█▓▒░Wanna see the code. Check it here : https://github.com/karthik-j/ProfilePage.git░▒▓█▇▆▅▄▃▂
▂▃▄▅▆▇█▓▒░Page developed using Laravel 5.1, Bootstrap, jquery and few other js plugins░▒▓█▇▆▅▄▃▂
...
<html>
 ...
 -->
        ...
        {!! Html::script('js/app.js', array(), true) !!} <!-- app.js Contains jquery and bootstrap-->
